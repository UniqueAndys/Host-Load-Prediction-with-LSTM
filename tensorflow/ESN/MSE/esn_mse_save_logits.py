...
flags.DEFINE_integer("output_dim", 12, "The length of prediction window")
...
def run_test_epoch(session, m, Win, W, data_x, data_y, eval_op, train_state):
    ...
    return (sum(costs)/len(costs), logits_sum)    
...
def main(_):
    ...
    with tf.Graph().as_default(), tf.Session() as session:
        ...
        for i in range(FLAGS.epoch):
            ...
            test_loss, logits = run_test_epoch(session, m_test, Win, W, 
            ...
            if i == FLAGS.epoch - 1:
                ...
                save_path = "./logits_esn_mse_1024_"+str(FLAGS.output_dim)+".pkl"
